...
export const getUsuarios = async(successCallback, errorCallback) => {
    const options = {
        method: 'GET',
        url: 'https://modaexpressbackend.herokuapp.com/usuarios/',
        headers: {
...
export const obtenerDatosUsuario = async(successCallback, errorCallback) => {
    const options = {
        method: 'GET',
        url: 'https://modaexpressbackend.herokuapp.com/usuarios/self',
        headers: {
...
export const patchUsuarios = async(id, data, successCallback, errorCallback) => {
    const options = {
        method: 'PATCH',
        url: `https://modaexpressbackend.herokuapp.com/usuarios/${id}/`,
